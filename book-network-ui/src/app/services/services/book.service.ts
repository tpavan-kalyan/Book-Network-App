...
import { updataArchivedStatus } from '../fn/book/updata-archived-status';
import { UpdataArchivedStatus$Params } from '../fn/book/updata-archived-status';
import { updataSharableStatus } from '../fn/book/updata-sharable-status';
import { UpdataSharableStatus$Params } from '../fn/book/updata-sharable-status';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `updataSharableStatus()` */
  static readonly UpdataSharableStatusPath = '/books/shareble/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `updataSharableStatus()` instead.
   *
   * This method doesn't expect any request body.
   */
  updataSharableStatus$Response(params: UpdataSharableStatus$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return updataSharableStatus(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `updataSharableStatus$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  updataSharableStatus(params: UpdataSharableStatus$Params, context?: HttpContext): Observable<number> {
    return this.updataSharableStatus$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  /** Path part for operation `updataArchivedStatus()` */
  static readonly UpdataArchivedStatusPath = '/books/archived/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `updataArchivedStatus()` instead.
   *
   * This method doesn't expect any request body.
   */
  updataArchivedStatus$Response(params: UpdataArchivedStatus$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return updataArchivedStatus(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `updataArchivedStatus$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  updataArchivedStatus(params: UpdataArchivedStatus$Params, context?: HttpContext): Observable<number> {
    return this.updataArchivedStatus$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  static readonly DeleteBookPath = '/books/remove/{book-id}';
